 ...
 * @author kjcar
 */
public class ScrollBarHorizontal extends BasicScrollBarUI {
      ...
      protected void paintThumb(Graphics g, JComponent c, Rectangle r) {
        ...
        g2.setPaint(color);
        g2.fillRoundRect(r.x, r.y+1+(r.height)/2, r.width, (r.height)/2, 2, 2);
        g2.setPaint(Interfaz.color3);
        g2.drawRoundRect(r.x, r.y+1+(r.height)/2, r.width, (r.height)/2, 2, 2);
        g2.dispose();
      }
